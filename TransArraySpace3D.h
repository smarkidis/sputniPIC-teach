...
inline void solver2phys(FPfield*** vectPhys, FPfield* vectSolver, int nx, int ny, int nz){
...
/** method to convert a 1D field in a 3D field not considering guard cells*/
inline void solver2phys(FPfield*** vectPhys1, FPfield*** vectPhys2, FPfield*** vectPhys3, FPfield* vectSolver, int nx, int ny, int nz){
    for ( int i=1; i < nx-1; i++)
      for ( int j=1; j < ny-1; j++)
        for ( int k=1; k < nz-1; k++){
...
inline void phys2solver(FPfield* vectSolver, FPfield*** vectPhys, int nx, int ny, int nz){
     for ( int i=1; i < nx-1; i++)
      for ( int j=1; j < ny-1; j++)
        for ( int k=1; k < nz-1; k++)
...
/** method to convert a 3D field in a 1D field not considering guard cells*/
inline void phys2solver(FPfield* vectSolver, FPfield*** vectPhys1, FPfield*** vectPhys2, FPfield*** vectPhys3, int nx, int ny, int nz){
     for ( int i=1; i < nx-1; i++)
      for ( int j=1; j < ny-1; j++)
        for ( int k=1; k < nz-1; k++){
