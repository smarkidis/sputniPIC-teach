...
inline void setGrid(struct parameters* param, struct grid* grd){
    ...
    grd->XN  = newArr3(FPfield, grd->nxn, grd->nyn, grd->nzn);
    grd->YN  = newArr3(FPfield, grd->nxn, grd->nyn, grd->nzn);
    grd->ZN  = newArr3(FPfield, grd->nxn, grd->nyn, grd->nzn);
...
/** Set up the grid quantities */
inline void printGrid(struct grid* grd){
    std::cout << std::endl;
...
inline void grid_deallocate(struct grid* grd){
...
inline void interpN2Cfield(FPfield ***vecFieldCx, FPfield ***vecFieldCy, FPfield ***vecFieldCz,FPfield ***vecFieldNx, FPfield ***vecFieldNy, FPfield ***vecFieldNz, struct grid* grd) {
...
/** interpolation Node to Center */
inline void interpC2Ninterp(FPinterp ***vecFieldN, FPinterp ***vecFieldC, struct grid* grd) {
    // nodes
    int nxn = grd->nxn;
    int nyn = grd->nyn;
    int nzn = grd->nzn;
...
/** interpolation Node to Center */
inline void interpC2Nfield(FPfield ***vecFieldN, FPfield ***vecFieldC, struct grid* grd) {
    // nodes
    int nxn = grd->nxn;
    int nyn = grd->nyn;
    int nzn = grd->nzn;
...
/** interpolation Node to Center */
inline void interpN2Cinterp(FPinterp ***vecFieldC, FPinterp ***vecFieldN, struct grid* grd) {
    // centers
    int nxc = grd->nxc;
    int nyc = grd->nyc;
    int nzc = grd->nzc;
...
inline void gradC2N(FPfield ***gradXN, FPfield ***gradYN, FPfield ***gradZN, FPfield ***scFieldC, grid* grd) {
...
/** calculate gradient on nodes, given a scalar field defined on central points  */
inline void gradN2C(FPfield ***gradXC, FPfield ***gradYC, FPfield ***gradZC, FPfield ***scFieldN, grid* grd) {
...
inline void divN2C(FPfield ***divC, FPfield ***vecFieldXN, FPfield ***vecFieldYN, FPfield ***vecFieldZN, grid* grd) {
...
inline void divSymmTensorN2C(FPinterp ***divCX, FPinterp ***divCY, FPinterp ***divCZ, FPinterp ***pXX, FPinterp ***pXY, FPinterp ***pXZ, FPinterp ***pYY, FPinterp ***pYZ, FPinterp ***pZZ, grid* grd) {
...
inline void divC2N(FPfield ***divN, FPfield  ***vecFieldXC, FPfield  ***vecFieldYC, FPfield  ***vecFieldZC, grid* grd) {
...
inline void curlC2N(FPfield ***curlXN, FPfield ***curlYN, FPfield ***curlZN, FPfield ***vecFieldXC, FPfield ***vecFieldYC, FPfield ***vecFieldZC, grid* grd) {
...
inline void curlN2C(FPfield ***curlXC, FPfield ***curlYC, FPfield ***curlZC, FPfield ***vecFieldXN, FPfield ***vecFieldYN, FPfield ***vecFieldZN, grid* grd) {
...
inline void lapN2N(FPfield ***lapN, FPfield ***scFieldN,  grid* grd) {
...
/** calculate laplacian on nodes, given a scalar field defined on nodes */
inline void lapN2N_V(FPfield ***lapN, FPfield ***scFieldN,  grid* grd) {
...
inline void lapC2C(FPfield ***lapC, FPfield ***scFieldC, grid* grd) {
