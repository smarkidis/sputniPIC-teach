...
inline void applyBCscalarDensN(FPinterp*** scalarN, grid* grd, parameters* param){
...
/** Apply BC to scalar interp quantity defined on nodes - Interpolation quantity */
inline void applyBCscalarFieldN(FPfield*** scalarN, grid* grd, parameters* param){
...
/** Apply BC to scalar interp quantity defined on nodes - Interpolation quantity */
inline void applyBCscalarFieldNzero(FPfield*** scalarN, grid* grd, parameters* param){
...
inline void applyBCids(struct interpDensSpecies* ids, struct grid* grd, struct parameters* param){
...
inline void applyBCscalarDensC(FPinterp*** scalarC, grid* grd, parameters* param){
...
inline void applyBCscalarFieldC(FPfield*** scalarC, grid* grd, parameters* param){
    ///////////////////////
    ///
    ///    FACE
    ///
...
inline void applyBCscalarFieldCzero(FPfield*** scalarC, grid* grd, parameters* param){
