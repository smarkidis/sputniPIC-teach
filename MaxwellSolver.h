...
inline void MaxwellSource(FPfield *bkrylov, grid* grd, EMfield* field ,EMfield_aux* field_aux,interpDens_aux* id_aux, parameters* param){
...
/** Maxwell Image */
inline void MaxwellImage(FPfield *im, FPfield *vector, EMfield *field, interpDensSpecies* ids, grid *grd, parameters *param){
...
inline void calculateE(grid* grd, EMfield_aux* field_aux, EMfield* field, interpDens_aux* id_aux, interpDensSpecies* ids, parameters* param){
...
inline void calculateB(grid* grd, EMfield_aux* field_aux, EMfield* field, parameters* param){
...
/* Poisson Image */
inline void PoissonImage(FPfield *image, FPfield *vector, grid * grd){
    // center cells
    int nxc = grd->nxc;
    int nyc = grd->nyc;
    int nzc = grd->nzc;
...
inline void divergenceCleaning(grid* grd, EMfield_aux* field_aux, EMfield* field, interpDensNet* idn, parameters* param){
...
inline void calculateHatDensities(struct interpDens_aux* id_aux, struct interpDensNet* idn, struct interpDensSpecies* ids, struct EMfield* field, struct grid* grd, struct parameters* param){
